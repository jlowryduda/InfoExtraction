...
public class TestOffsetConjunctions extends TestCase
{
	...
	public void testOne ()
	{
		...
		assertTrue (ts.getToken(0).getFeatureValue("a&b@1") == 1.0);
		assertTrue (ts.getToken(0).getFeatureValue("V&a") == 1.0);
		assertTrue (ts.getToken(2).getFeatureValue("b@-1&c&d@1") == 1.0);
	}
