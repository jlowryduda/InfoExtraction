...
/**
	 An machine learning "example" to be used in training, testing or
	 performance of various machine learning algorithms.

	 <p>Includes data input and target output, as well as a short
	 identifying "name" (such as a filename), and human-readable source
	 information, (such as the original text).
	 ...
	 <p>Although unlocked Instances are mutable, typically the only code that
